...
_STEP_TIMES = {
    "fast":      {1: "约 10-20 秒", 2: "约 20-40 秒",  3: "约 10-20 秒", 4: "约 5-10 秒"},
    "standard":  {1: "约 15-30 秒", 2: "约 30-90 秒",  3: "约 10-25 秒", 4: "约 5-12 秒"},
    "fine":      {1: "约 20-40 秒", 2: "约 1-2 分钟",  3: "约 10-30 秒", 4: "约 5-15 秒"},
}
...
def _admin_ask_ai(user_msg: str, current_config: dict) -> dict:
    client = OpenAI(base_url=AGNES_BASE_URL, api_key=AGNES_API_KEY, timeout=120.0)
